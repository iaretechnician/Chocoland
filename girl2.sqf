...
_dummyUnit = (_ar select 4) createUnit ["RU_Hooker4", [0, 0, 0], [], 0, "NONE"]; // Join in the old group incase there was only 1 member
[_oldUnit] join _dummyGroup;
 _newUnit = _dummyGroup createUnit ["RU_Hooker4", _ar select 5, [], 0, "NONE"];
sleep 0.3;
