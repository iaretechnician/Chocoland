...
// Check if the player is on debug island, if so we don't want to do anything.
_debugPos = getMarkerPos "debugMarker";

if ((_playerPos distance _debugPos) <= 60) exitWith {
	true spawn {
