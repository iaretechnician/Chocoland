...
player globalchat format["test %1",_payment];
 _var="choco";
      ...
      if(_payment==0)then{_chocos =( player getvariable "choco")*2;
       ...
       else{player setvariable["choco",0,true];hint"you're not lucky this time, you lost all XD";};
   }
       ...
       else{player setvariable["bounty",0,true];hint"you're not lucky this time, you lost all XD";};};
