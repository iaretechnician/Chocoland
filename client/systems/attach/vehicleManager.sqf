...
call compile format["object1 setObjectTexture [%5, ""#(rgb,8,8,3)color(%1,%2,%3,%4)""];",_RED,_GREEN,_BLUE,_alpha,_player];
 publicvariable"object1";       
call compile format["chocostring = ""object1 setobjecttexture [%5, """"#(rgb,8,8,3)color(%1,%2,%3,%4)""""];"";",_RED,_GREEN,_BLUE,_alpha,_player];
//hint format ["%1",chocostring];
