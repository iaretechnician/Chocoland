...
_vehicle = player getvariable["saveVehicle",nil];
_vehicle2 = player getvariable["chocopack",nil];
if(!isnil "_vehicle")then{
    _vehicle3 = (configFile >> "CfgVehicles" >> _vehicle);_vehicle = getText(_vehicle3 >> "displayName");};
