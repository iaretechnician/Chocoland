...
class vehshopd {
	...
	onLoad = "[] spawn PopulateVehStore";	//"[] execVM 'client\systems\vehicleStore\PopulateVehStore.sqf'";
	...
	class controls {
		...
		{
			idc = -1;
			onButtonClick = "[] execVM 'client\systems\vehicleStore\buyVehicle.sqf'";
			text = "Buy";
