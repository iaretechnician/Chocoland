...
_dummyUnit = (_ar select 4) createUnit ["WildBoar", [0, 0, 0], [], 0, "NONE"]; // Join in the old group incase there was only 1 member

[_oldUnit] join _dummyGroup;
 
 _newUnit = _dummyGroup createUnit ["WildBoar", _ar select 5, [], 0, "NONE"];
...
player setVariable["choco",mybounty,false];
