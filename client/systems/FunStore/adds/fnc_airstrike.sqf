...
[_ma2, 1] setWaypointStatements ["true"," _bomb = ""Bo_GBU12_LGB"" createVehicle _poss;AirSupport flyInHeight 200;"];

[_ma2, 2] setWaypointType "SAD";
[_ma2, 2] setWaypointSpeed "FULL";
[_ma2, 2] setWaypointBehaviour "CARELESS";
[_ma2, 2] setWaypointStatements ["true", " _bomb = ""Bo_GBU12_LGB"" createVehicle _poss;AirSupport flyInHeight 200;"];

[_ma2, 3] setWaypointType "SAD";
[_ma2, 3] setWaypointSpeed "FULL";
[_ma2, 3] setWaypointBehaviour "CARELESS";
[_ma2, 3] setWaypointStatements ["true", " _bomb = ""Bo_GBU12_LGB"" createVehicle _poss;AirSupport flyInHeight 200;"];

[_ma2, 4] setWaypointType "CYCLE";
[_ma2, 4] setWaypointSpeed "FULL";
[_ma2, 4] setWaypointBehaviour "CARELESS";
[_ma2, 4] setWaypointStatements ["true", " _bomb = ""Bo_GBU12_LGB"" createVehicle _poss;AirSupport flyInHeight 200;"];
