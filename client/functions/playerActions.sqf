...
//aActionsIDs = aActionsIDs + [player addAction["Spawn here my MotherShip", "client\systems\generalStore\adds\ship.sqf", [], 1, false, false, "", 'shipspawned and (player getvariable"mothership")select 0 == 1;player distance (nearestobjects [player, ["RHIB2Turret"],  30] select 0) < 30']];
//aActionsIDs = aActionsIDs + [player addAction["getin Mothership", "client\systems\generalStore\adds\ship1.sqf", [1], 1, false, false, "", 'shipspawned and (player getvariable"mothership")select 0 == 1;player distance (nearestobjects [player, ["RHIB2Turret"],  30] select 0) < 30']];
//aActionsIDs = aActionsIDs + [player addAction["Hide Mothership","client\systems\generalStore\adds\ship1.sqf", [4], 1, false, false, "", 'shipspawned and (player getvariable"mothership")select 0 == 1;player distance (nearestobjects [player, ["RHIB2Turret"],  30] select 0) < 30']];
...
aActionsIDs = aActionsIDs + [player addAction["decode this object", "client\functions\decoder.sqf", [], -10, false, false, "", 'player getvariable"decoder" == 1 and !Dcooldown']];
