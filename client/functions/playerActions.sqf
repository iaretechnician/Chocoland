...
aActionsIDs = aActionsIDs + [player addAction["Activate BaseCore lvl 2", "client\functions\basecore_1.sqf", [], 1, false, false, "", 'player distance (nearestobjects [player, ["76n6ClamShell"],  20] select 0) < 20; _obj = (nearestobjects [player, ["76n6ClamShell"],  20]); (_obj select 0 )getvariable"basecore" == 0;']];
aActionsIDs = aActionsIDs + [player addAction["Destroy BaseCore lvl 2", "client\functions\basecore_d1.sqf", [], 1, false, false, "", 'player distance (nearestobjects [player, ["76n6ClamShell"],  20] select 0) < 20; _obj = (nearestobjects [player, ["76n6ClamShell"],  20]); (_obj select 0 )getvariable"basecore" == 1;']];
