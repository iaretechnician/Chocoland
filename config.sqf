...
weaponsArray = [
	...
	[4, "RPK","RPK_74",25000,2500],
        [2, "L85A2 AWS","BAF_L85A2_RIS_CWS", 100000,10000],
    // Anti-tank
...
["Invisible 5mn",160000,"invisible"],
