...
vehicleStoreArray = [
	...
	["Vodnik (2xPK) [Russia]", 2000,"GAZ_Vodnik"],
        ["HMMWV M2", 1000,"HMMWV_M2"],
        ["BTR-40 DshKM", 2000,"BTR40_MG_TK_INS_EP1"],
	...
	["Vodnik (BPPU) [Russia]", 2000,"GAZ_Vodnik_HMG"],
        ["Jackal 2 MWMIK GMG", 4500,"BAF_Jackal2_L2A1_D"],
	["BRDM-2 ATGM", 7000,"BRDM2_ATGM_CDF"],
	["Stryker (TOW) [US]", 9800,"M1135_ATGMV_EP1"],
	["Stryker MGS [US]", 10000,"M1128_MGS_EP1"],
        ["MTVR (Fuel)", 10000,"MTVR_Refuel"],
        ["Utility Truck Ammunition", 10000,"KamazReammo"],
	["HMMWV Avenger", 10000,"HMMWV_Avenger"],
