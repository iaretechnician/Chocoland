...
sleep 10;
_hint = parseText format ["<t color='#FFBF00' size='2' shadow='2' shadowColor='#000000' align='center'>ChocoLand</t><br />------------------------<br />Welcome To ChocoLand - Wasteland MOD BaseDefense - The MoneyIsland"];
[nil,player,"loc",rHINT,_hint] call RE;
_multipier = 1;
sleep 300;
while {true} do 
{
_bounty = 50 * _multipier;
