...
_randombase= ["outpostUS1","outpostVIP","smallBase1"] call BIS_fnc_selectRandom;
_base = [_randombase, 0,_pos] execVM "server\functions\createOutpost.sqf";
...
if(_result == 1) then
{
    ...
    _baseToDelete = _randomPos nearEntities ["All", 22];
