...
_vehicleName = getText (configFile >> "cfgVehicles" >> typeOf _vehicle >> "displayName");
 _war1 = Round (random 100)+800;
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Special Mission %6</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>A<t color='%4'> %3</t> has been designated to fly in supplies.</t>", _missionType, _picture, _vehicleName, mainMissionColor, subTextColor,_war1];
