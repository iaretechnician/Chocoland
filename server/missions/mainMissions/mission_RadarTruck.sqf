...
_vehicleName = getText (configFile >> "cfgVehicles" >> typeOf _vehicle >> "displayName");
  _war1 = Round (random 100)+700;
_hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Main Mission %6</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>A<t color='%4'> %3</t> Mobile Radar Vehicle has been immobilized. Sieze it before your enemies do!</t>", _missionType, _picture, _vehicleName, mainMissionColor, subTextColor, _war1];
[nil,nil,rHINT,_hint] call RE;

//CivGrpM = createGroup civilian;
CivGrpM =MissionGroups;
...
if(_result == 1) then
{
    ...
    _hint = parseText format ["<t align='center' color='%4' shadow='2' size='1.75'>Mission %6 Complete</t><br/><t align='center' color='%4'>------------------------------</t><br/><t align='center' color='%5' size='1.25'>%1</t><br/><t align='center'><img size='5' image='%2'/></t><br/><t align='center' color='%5'>The radar truck has been captured.</t>", _missionType, _picture, _vehicleName, successMissionColor, subTextColor, _war1];
	[nil,nil,rHINT,_hint] call RE;
    diag_log format["WASTELAND SERVER - Main Mission Success: %1",_missionType];
      //Cash Reward
        _missionRewardRadius =200;
_reward = Round(random 750) +5000;
