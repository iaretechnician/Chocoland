...
_leader addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 500);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Support
...
_man2 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 400);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Rifle_man
...
_man3 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 300);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Rifle_man
...
_man4 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 300);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Sniper
...
_man5 addMagazine "10Rnd_762x54_SVD";
_man5 addWeapon "SVD";
_man5 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 380);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Grenadier
...
_man6 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 380);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Support
...
_man7 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 450);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Grenadier
...
_man8 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 300);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Sniper
...
_man9 addMagazine "10Rnd_762x54_SVD";
_man9 addWeapon "SVD";
_man9 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 400);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
//Rifle_man
...
_man10 addEventHandler ["killed", {_killer = _this select 1;_amount = 100+Round(random 300);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
