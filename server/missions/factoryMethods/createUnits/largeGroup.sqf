...
_man2 setskill ["aimingaccuracy",0.3];
...
_man4 setskill ["aimingaccuracy",0.3];
...
_man6 setskill ["aimingaccuracy",0.3];
...
_man8 setskill ["aimingaccuracy",0.3];
_man8 setIdentity "name14";
_man8 disableAI "MOVE";
//Sniper
...
_man9 addMagazine "10Rnd_762x54_SVD";
_man9 addWeapon "SVD";
_man9 setskill ["aimingaccuracy",0.2];
_man9 setIdentity "name15";
_man9 disableAI "MOVE";
//Rifle_man
...
_man10 setskill ["aimingaccuracy",0.2];
_man10 setIdentity "name16";
_man10 disableAI "MOVE";
