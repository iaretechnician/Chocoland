...
_leader addEventHandler ["killed", {_killer = _this select 1;_amount = 50+Round(random 200);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
...
_man4 addMagazine "10Rnd_762x54_SVD";
_man4 addWeapon "SVD";
_man4 addEventHandler ["killed", {_killer = _this select 1;_amount = 50+Round(random 150);_killer setVariable ["cmoney", (_killer getVariable ["cmoney", 0]) + _amount, true];}];
