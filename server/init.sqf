...
"PK","Pecheneg","RPK_74","BAF_L85A2_RIS_CWS","Igla","Javelin","M136","M32_EP1","M47Launcher_EP1","M79_EP1","MAAWS","MetisLauncher","Mk13_EP1",
"BAF_NLAW_Launcher","RPG7V","SMAW","Stinger","Strela"];
...
MissionGroups =createGroup CIVILIAN;
...
if (serverDatabaseOn)then{
    []spawn{
//Save System  Big Thanks to creedcoder
call compile preProcessFile "\iniDBi\init.sqf";
execVM "itemSave\init.sqf";};
};
//carrier spawn
_Carrierpos =[[2448,8716],[2688,8716]];
_objects=[
[[3301.79,3608.9,0.00143814],"Land_HouseB_Tenement"],
[[3727.52,3841.4,0.00135422],"Land_A_TVTower_Base"],
[[3749.97,3189.22,0.0013237],"Land_A_TVTower_Base"],
...
diag_log format ["WASTELAND SERVER Carrier Spawned"];
...
onPlayerDisconnected {
    _data=fp8 getvariable _uid;       
    diag_log (["Moneystats for player:",[_name,_data]]);
    call compile format["_dataserver = %1;", ["Moneystats for player:($,Multi)",_uid,_data]];
    };